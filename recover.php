            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center pt-200">
                        <h2 data-splitting class="breadcrumb-title wow fadeInUp" data-wow-duration=".003s" data-wow-delay=".003s">Update Password!</h2>
                    ...
                    <div class="col-12"><!-- start col-6 -->
                        <div class="acount_form_bg text-center wow fadeInDown" data-wow-duration=".4s" data-wow-delay=".4s" style="visibility: visible; animation-duration: 0.4s; animation-delay: 0.4s;">
                            <div class="form-group account_input col-md-12 pb-10">
                                <input type="password" name="password" id="fpassword" class="form-control account_style" placeholder="New Password">
                            </div>
                            <div class="form-group account_input col-md-12 pb-10">
                            ...
                            <div class="row mt-5">
                                <div class="col-lg-12">
                                    <div class="account_form_area text-center">
                                        <button type="button" class="btn btn-account btn-contact-bg" id="update">Update Password</button>
                                    </div>                          
                                </div>
